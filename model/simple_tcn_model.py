...
def prepare(class_num, blank_index=0, image_size=(96, None, 3), last_conv_filter=256, bottle_neck=128, tcn_unit=256):
...
def conv1d_block(input, num_filters, dilate):
    x = tf.keras.layers.Conv1D(num_filters, 3, dilation_rate=dilate, activation="swish", padding="same")(input)
